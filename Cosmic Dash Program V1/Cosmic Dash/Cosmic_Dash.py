...
play_img = pygame.image.load("Cosmic Dash Program V1/Cosmic Dash/images/playbutton.png")
play_button = buttons.Button(250,125,play_img,0.5)

settings_img = pygame.image.load("Cosmic Dash Program V1/Cosmic Dash/images/settingsbutton.png")
